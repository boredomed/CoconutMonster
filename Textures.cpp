...
// Background canvas
void draw(GLuint id, int x, int y, int wd, int ht)
{
	...
	glTexCoord2f(1.0, 0.0);		glVertex2f(x + wd, y);
	glTexCoord2f(1.0, 1.0);		glVertex2f(x + wd, y - ht);
	glTexCoord2f(0.0, 1.0);		glVertex2f(x, y - ht);
...
void draw_i(GLuint id, int x, int y, int wd, int ht)
{
	...
	glTexCoord2f(0.0, 0.0);		glVertex2f(x + wd, y);
	glTexCoord2f(1.0, 0.0);		glVertex2i(x, y); 
	glTexCoord2f(1.0, 1.0);		glVertex2f(x, y - ht);
	glTexCoord2f(0.0, 1.0);		glVertex2f(x + wd, y - ht); 
